...
// slightly modified to fit the upscaling demo
...
double genann_act_tanh_cached(double a)
{
...
void genann_train(genann const *ann, double const *inputs, double const *desired_outputs, double learning_rate) {
    ...
    /* First set the output layer deltas. */
    {
        ...
        //if (ann->activation_output == genann_act_tanh || ann->activation_output == genann_act_tanh_cached) {
        //    for (j = 0; j < ann->outputs; ++j) {
        //        *d++ = (*t - *o) * (1.0 - *o);
        //        ++o; ++t;
        //    }
        //} else if (ann->activation_output == genann_act_linear) {
            for (j = 0; j < ann->outputs; ++j) {
                *d++ = *t++ - *o++; // linear actuation has no gradient
            }
        //}
    }
